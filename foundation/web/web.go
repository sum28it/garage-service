// package web is a small framework extension
package web
...
// SignalShutdown method is used to gracefully shutdown the server
// when an integrity issue has been identified
...
func (a *App) Handle(method string, path string, handler Handler, mw ...Middleware) {
	...
	// Wrap the route level middleware
	handler = WrapMiddleware(mw, handler)
	// Wrap the application level middleware
